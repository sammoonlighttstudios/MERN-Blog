      ...
      <div className='flex p-3  max-w-3xl mx-auto flex-col md:flex-row md:items-center gap-5'>
        ...
        <div className='flex-1'>
          ...
          <p className="text-sm mt-5">
            ...
            This is a demo project. You can sigm in with your email and password.
            or with Google
        ...
        <div className='flex-1'>
          <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <TextInput type="email" placeholder="name@company.com" id="email" onChange={handleChnage}
              />
            </div>
            <div>
              <Label value="Your Password" />
              <TextInput type="password" placeholder="*******" id="password" onChange={handleChnage}
              />
            </div>
